...
describe("Simple Queries", () => {
  ...
  it(
    ...
    async done => {
      const query = `SELECT COUNT() AS count FROM movies WHERE budget > 100000000 AND '2009-01-01' < release_date`;
      const result = await db.selectSingleRow(query);
  ...
  it(
    ...
    async done => {
      const query = `SELECT original_title, budget, revenue FROM movies WHERE '2009-01-01' < release_date ORDER BY budget DESC LIMIT 3`;
